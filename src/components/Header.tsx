...
import { GithubIcon, RankingIcon } from "hugeicons-react";
const Header = () => {
  return (
    <div className="flex px-20 py-10 items-center ">
      ...
      <div className="ml-auto flex gap-5 text-gray-600">
        <a href="#">
          <RankingIcon size={28} />
        </a>
        <a href="https://github.com/TheLeeJungYan/math-quiz" target="__blank">
          <GithubIcon size={28} />
        </a>
      </div>
    </div>
